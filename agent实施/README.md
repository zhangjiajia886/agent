...
| P1 状态持久化 | `02_P1_持久化/P1_任务状态持久化设计.md` | `98_测试用例/P1_持久化测试用例.md` | 待实施 | 实现 `AgentTaskStore` |
| P9 数据库与 Redis 状态层 | `10_P9_数据库与Redis状态层/P9_数据库与Redis状态层设计.md` | `98_测试用例/P9_数据库与Redis状态层测试用例.md` | 待实施 | 明确 DB 权威状态与 Redis 运行状态边界 |
| P10 Agent 设计模式 | `11_P10_Agent设计模式/P10_Agent设计模式选型.md` | `98_测试用例/P10_Agent设计模式验证用例.md` | 待实施 | 明确采用、暂缓和不建议采用的 Agent 模式 |
| P2 TaskPlanner | `03_P2_Planner/P2_TaskPlanner设计.md` | `98_测试用例/P2_Planner测试用例.md` | 待实施 | 定义工具能力元数据与规则模板 |
...
| P7 沙箱与安全 | `08_P7_沙箱与安全/P7_Sandbox与安全隔离设计.md` | `98_测试用例/P7_Sandbox安全测试用例.md` | 待实施 | 为高风险工具建立沙箱策略 |
| P8 工具治理 | `09_P8_工具治理/P8_工具治理设计.md` | `98_测试用例/P8_工具治理测试用例.md` | 待实施 | 补充工具能力元数据和健康检查 |
| P11 成本与预算控制 | `12_P11_成本与预算控制/P11_成本与预算控制设计.md` | `98_测试用例/P11_成本预算测试用例.md` | 待实施 | 定义 TaskBudget 和 BudgetUsage |
