...
| 模块 | 设计文档 | 当前状态 | 对应后端 |
|---|---|---|---|
| F1 任务工作台 | `20_前端设计/F1_任务工作台/设计文档.md` | 待实施 | P0/P3 |
| F2 事件回放 | `20_前端设计/F2_事件回放/设计文档.md` | 待实施 | P6 |
| F3 审批交互 | `20_前端设计/F3_审批交互/设计文档.md` | 待实施 | P5/P7 |
| F4 工具管理 | `20_前端设计/F4_工具管理/设计文档.md` | 待实施 | P8 |
| F5 预算展示 | `20_前端设计/F5_预算展示/设计文档.md` | 待实施 | P11 |
| F6 Trace 时间线 | `20_前端设计/F6_Trace时间线/设计文档.md` | 待实施 | P6 |
| F7 组件拆分 | `20_前端设计/F7_组件拆分/设计文档.md` | **进行中** (types + useTask) | — |
