...
| P5 Replanner | `06_P5_Replanner/P5_Replanner与RecoveryPolicy设计.md` | `98_测试用例/P5_Replanner测试用例.md` | **已落地 + 主循环集成** | ✅ 前端 F3 已完成 |
| P6 恢复与观测 | `07_P6_恢复与观测/P6_断线恢复事件回放与Tracing设计.md` | `98_测试用例/P6_恢复与观测测试用例.md` | **已落地 + retry API** | ✅ 前端 F2/F6 已完成 |
| P7 沙箱与安全 | `08_P7_沙箱与安全/P7_Sandbox与安全隔离设计.md` | `98_测试用例/P7_Sandbox安全测试用例.md` | **已落地** | 审计事件持久化 / 自动化测试 |
| P8 工具治理 | `09_P8_工具治理/P8_工具治理设计.md` | `98_测试用例/P8_工具治理测试用例.md` | **已落地 + API** | ✅ 前端 F4 已完成 |
| P11 成本与预算控制 | `12_P11_成本与预算控制/P11_成本与预算控制设计.md` | `98_测试用例/P11_成本预算测试用例.md` | **已落地** | ✅ 前端 F5 已完成 / budget_warning 事件待接 |

### 前端模块

| 模块 | 设计文档 | 当前状态 | 对应后端 |
|---|---|---|---|
| F1 任务工作台 | `20_前端设计/F1_任务工作台/设计文档.md` | **✅ 已完成** | P0/P3 |
| F2 事件回放 | `20_前端设计/F2_事件回放/设计文档.md` | **✅ 已完成** | P6 |
| F3 审批交互 | `20_前端设计/F3_审批交互/设计文档.md` | **✅ 已完成** | P5/P7 |
| F4 工具管理 | `20_前端设计/F4_工具管理/设计文档.md` | **✅ 已完成** | P8 |
| F5 预算展示 | `20_前端设计/F5_预算展示/设计文档.md` | **✅ 已完成** | P11 |
| F6 Trace 时间线 | `20_前端设计/F6_Trace时间线/设计文档.md` | **✅ 已完成** | P6 |
| F7 组件拆分 | `20_前端设计/F7_组件拆分/设计文档.md` | **✅ 已完成** | — |
